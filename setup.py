...
subprocess.run(["wget", "https://raw.githubusercontent.com/cms66/rpi-pyhome/main/setup_base.sh"], capture_output=True, shell = True, executable="/bin/bash")
print(subprocess.run(["sudo", "bash", "./setup_base.sh"], capture_output=True, shell = True, executable="/bin/bash"))
