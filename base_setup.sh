...
update_system()
{
	...
	apt-get -y update
	apt-get -y upgrade
	apt-get -y install python3-dev gcc g++ gfortran libraspberrypi-dev libomp-dev git-core build-essential cmake pkg-config make screen htop stress-ng zip nfs-common fail2ban ufw ntpdate bzip2 pkgconf openssl
